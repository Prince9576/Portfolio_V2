...
// A WebAudio buffer source loops sample-accurately (no audible restart), and all
// smoothing happens on the audio thread (setTargetAtTime), so calling setEngine
// every render frame costs nothing on the main thread — no frame drops. ----
