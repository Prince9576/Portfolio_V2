// Work-experience shrines. Each company gets its own fountain landmark (assigned
// nearest-spawn first in Shrines.jsx), a logo rendered as the particle mark, and
// a DOM panel. Adding another company is just another entry here.
//
// logo.mode:
//   'alpha' — keep pixels whose alpha > 140 (transparent-background PNGs)
//   'ink'   — keep pixels darker than lumaMax (logos on a white JPEG background)
// logo.shade/sat/gain tune how the sampled pixel colors read as additive glow.
...
export const COMPANIES = [
  ...
  },
  {
    ...
    bullets: PRATISHTHAN,
    logo: {
      url: "/textures/pratishthan-logo.jpeg",
      mode: "ink",
      lumaMax: 0.82,
      shade: 1,
      sat: 1.15,
